...
set CLASSPATH=%APP_HOME%\lib\backend-1.0.jar;%APP_HOME%\lib\postgresql-42.2.12.jar;%APP_HOME%\lib\gson-2.8.6.jar

@rem Execute backend
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %BACKEND_OPTS%  -classpath "%CLASSPATH%" org.effectively.Main %CMD_LINE_ARGS%
